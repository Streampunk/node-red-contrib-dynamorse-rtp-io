...
test('Bytes are converted to RFC6184', (t) => {
  ...
  t.ok(g.buffers.every(b => Buffer.isBuffer(b)),
...
test('Bytes roundtrip', t => {
  ...
  t.equal(g.buffers[0].indexOf(Buffer.from([0, 0, 0, 1])), 0,
